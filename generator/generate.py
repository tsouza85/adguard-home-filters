...
if settings_yaml:
    ...
    # Input files
    file_header = settings_yaml['file_include']['header'] or os.path.join(path_base, 'header')
    # Domain whitelist
    file_filter_whitelist = settings_yaml['file_include']['filter_whitelist'] or os.path.join(path_base, 'filter_whitelist')
    # Output files
